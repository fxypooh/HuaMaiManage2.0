<template>
	<div>
		<h1 class="pageTitle">测试客户详情-{{statusMsg}}</h1>
		<el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
      <el-row>
        <el-col :span="8">
          <el-form-item label="所属经销商编码" prop="dealercode">
            <el-input v-model.trim="ruleForm.dealercode" placeholder="请输入所属经销商编码" maxlength="20"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
...
export default {
  ...
  data () {
    ...
    return {
      ...
      rules: {
        dealercode:[
          { required: true, message: '请输入所属经销商编码', trigger: 'blur' }
        ],
        name:[
